...
export default function DepartmentsSection({ HorizontalScroll = true }) {
    ...
    return (
        <section className="text-gray-600 body-font mb-12">
            <AnimatedElement>
                <h1 className="m-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-4xl lg:text-5xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-red-700 from-red-400">| DEPARTMENTS </span> :</h1>
            </AnimatedElement>
